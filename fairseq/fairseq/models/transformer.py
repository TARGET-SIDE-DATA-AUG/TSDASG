...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--temperature', type=float, default=1,
                            help='hyper-parameter temperature in our method, details can be seen in the paper')
        parser.add_argument('--alpha', type=float, default=2,
                            help='hyper-parameter alpha in our method, details can be seen in the paper')
        # fmt: on
    @classmethod
    ...
    def forward(
        ...
        return decoder_out1, decoder_out2
    ...
    def get_normalized_probs(
        ...
        #print("transformer.py line 356: Get normalized probabilities (or log probs) from a net's output")
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(
        ...
        return EncoderOut(
            encoder_out=x,  # T x B x C `(seq_len, batch, embed_dim)`
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def forward(
        ...
        output, extra = self.extract_features(
            prev_output_tokens,
            encoder_out=encoder_out,
    ...
    def extract_features_scriptable(
        ...
        if x is None:
            ...
            x = self.embed_scale * (1 - mix_ratio) * x + mix_ratio * self.embed_scale * self.embed_tokens(prev_output_tokens)
